 ...
 * @param {boolean} [args.allowMergingCells=false] - Allow user to merge cells into a single cell.
 ...
 * @param {string} [args.showRemoveAllGroupColumns='Remove all column groups'] - Text that appears on the remove all column groups option.
 * @param {string} [args.showRemoveAllGroupRows='Remove all row groups'] - Text that appears on the remove all row groups option.
 * @param {string} [args.showExpandAllGroupColumns='Expand all column groups'] - Text that appears on the expand all column groups option.
 * @param {string} [args.showExpandAllGroupRows='Expand all row groups'] - Text that appears on the expand all row groups option.
 * @param {string} [args.showCollapseAllGroupColumns='Collapse all column groups'] - Text that appears on the collapsed all column groups option.
 * @param {string} [args.showCollapseAllGroupRows='Collapse all row groups'] - Text that appears on the collapsed all row groups option.
 * @param {string} [args.columnGroupIndicatorPosition='right'] - The position of the column group inidcator(icon), available values: 'left' and 'right'.
 * @param {string} [args.rowGroupIndicatorPosition='bottom'] - Ths position of the row group indicator(icon), available values: 'top' and 'bottom'.
 * @param {string} [args.showMergeCells='Merge cells'] - Text that appears when selected cells are mergeable.
 * @param {string} [args.showMergeCellsHorizontally='Merge cells horizontally'] - Text that appears when selected cells are mergeable horizontally.
 * @param {string} [args.showMergeCellsVertically='Merge cells vertically'] - Text that appears when selected cells are mergeable vertically.
 * @param {string} [args.showUnmergeCells='Unmerge cells'] - Text that appears when selected cell are unmergeable.
 ...
 * @param {boolean} [args.resizeAfterDragged] - Resize after the handle is dropped, similar to Excel.
 ...
 * @property {array} mergedCells - Cells that are merged.
 ...
 * @param {number} args.fillPosition - Increase in position since the first filling of the cells regardless of whether they are rows or columns. This doesn't reset and will start with '0'.
 * @param {object} args.userData - An empty object that users can use to store state for a given fill operation.
 */
/**
 ...
 * @property {number} [cellBorderWidth=0.5] - Style of cellBorderWidth.
 ...
 * @property {string} [cornerCellBackgroundColor=rgba(245, 245, 245, 1)] - Style of cornerCellBackgroundColor.
 * @property {string} [cornerCellBorderColor=rgba(162, 162, 162, 1)] - Style of cornerCellBorderColor.
 ...
 * @property {string} [fillOverlayBorderColor=rgba(125, 125, 125, 1)] - Style of fillOverlayBorderColor.
 * @property {number} [fillOverlayBorderWidth=1] - Style of fillOverlayBorderWidth.
 * @property {string} [gridBackgroundColor=rgba(240, 240, 240, 1)] - Style of gridBackgroundColor.
 * @property {string} [gridBorderColor=rgba(162, 162, 162, 1)] - Style of gridBorderColor.
 * @property {number} [gridBorderWidth=0.5] - Style of gridBorderWidth.
 ...
 * @property {string} [columnHeaderCellCapBackgroundColor=rgba(245, 245, 245, 1)] - Style of columnHeaderCellBackgroundColor.
 * @property {string} [columnHeaderCellCapBorderColor=rgba(162, 162, 162, 1)] - Style of columnHeaderCellBackgroundColor.
 * @property {number} [columnHeaderCellCapBorderWidth=0.5] - Style of columnHeaderCellBackgroundColor.
 * @property {string} [columnHeaderCellBorderColor=rgba(152, 152, 152, 1)] - Style of columnHeaderCellBorderColor.
 * @property {number} [columnHeaderCellBorderWidth=1] - Style of columnHeaderCellBorderWidth.
 * @property {string} [columnHeaderCellColor=rgba(50, 50, 50, 0.9)] - Style of columnHeaderCellColor.
 * @property {string} [columnHeaderCellFont=13px sans-serif] - Style of columnHeaderCellFont.
 ...
 * @property {string} [columnHeaderCellSelectedBackgroundColor=rgba(217, 217, 217, 1)] - Style of columnHeaderCellSelectedBackgroundColor.
 ...
 * @property {string} [resizeMarkerColor=rgba(0, 0, 0, 0.2)] - Style of resizeMarkerColor.
 * @property {number} [resizeMarkerSize=2] - Style of resizeMarkerSize.
 * @property {number} [rowGroupColumnWidth=25] - Style of rowGroupColumnWidth.
 * @property {string} [rowHeaderCellBackgroundColor=rgba(245, 245, 245, 1)] - Style of rowHeaderCellBackgroundColor.
 * @property {string} [rowHeaderCellBorderColor=rgba(162, 162, 162, 1)] - Style of rowHeaderCellBorderColor.
 * @property {number} [rowHeaderCellBorderWidth=-0.5] - Style of rowHeaderCellBorderWidth.
 * @property {string} [rowHeaderCellColor=rgba(50, 50, 50, 0.9)] - Style of rowHeaderCellColor.
 * @property {string} [rowHeaderCellFont=13px sans-serif] - Style of rowHeaderCellFont.
 * @property {number} [rowHeaderCellHeight=25] - Style of rowHeaderCellHeight.
 * @property {string} [rowHeaderCellHorizontalAlignment=center] - Style of rowHeaderCellHorizontalAlignment.
