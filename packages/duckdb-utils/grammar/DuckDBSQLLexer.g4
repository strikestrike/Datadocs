...
Float_Literal: (Digit+ Dot Digit* | Dot? Digit+ | HexNumber) (Exponent | E); // allow 'e' as shortform
Decimal_Literal: Digit+ Dot Digit* | Dot Digit+;
...
INTERVAL:                       I N T E R V A L|D U R A T I O N;
IS:                             I S;
JOIN:                           J O I N;
LEFT:                           L E F T;
LIKE:                           L I K E;
...
fragment CONTAINS:              C O N T A I N S;
...
fragment GROUPING:              G R O U P I N G;
...
BOOLEAN:                        B O O L E A N | B O O L | L O G I C A L;
INTEGER:                        I N T E G E R |  I N T ('64')?;
FLOAT:                          F L O A T ('64')? | R E A L | D O U B L E;
DECIMAL:                        D E C I M A L | (B I G)? N U M E R I C;
RATIONAL:                       R A T I O N A L;
STRING:                         S T R I N G | T E X T | V A R C H A R;
BYTES:                          B Y T E S | B I N A R Y | B L O B | B Y T E A;
DATE:                           D A T E;
TIME:                           T I M E;
DATETIME:                       D A T E T I M E | T I M E S T A M P '_' N T Z;
TIMESTAMP:                      T I M E S T A M P ('_' L? T Z)?;
JSON:                           J S O N;
VARIANT:                        V A R I A N T;
GEO:                            G E O G R A P H Y;

OTHER_NUMERIC:                  U? I N T ('64' | '32' | '16' | '8') | F L O A T '32';
